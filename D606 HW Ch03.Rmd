...
**N(mu=4313, sigma=583), N(mu=5261,807)**
...
**They do follow the 68-95-99.7 rule, and they form a petty straight line on a qqplot.**
```{r}
qqnorm(heights)
qqline(heights)
```
...
**The mean is not affected, and the standard deviation decreases.**
...
```{r}
my.set <- c("b","b","g")
sample.space <- unique(permn(my.set))
sample.space
